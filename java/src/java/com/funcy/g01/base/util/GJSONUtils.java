...
public class GJSONUtils {
	 ...
	 * @since 1.0
	 */
	public static String toJson(final Object target, final Type targetType,
			final boolean isSerializeNulls, final Double version,
			String datePattern, final boolean excludesFieldsWithoutExpose) {
		if (target == null) {
			return EMPTY_JSON;
		}
	 ...
	 * @since 1.0
	 */
	public static String toJson(final Object target, final Double version) {
	 ...
	 */
	public static String toJson(final Object target,
			final boolean excludesFieldsWithoutExpose) {
	 ...
	 */
	public static String toJson(final Object target, final Type targetType,
			final Double version, final boolean excludesFieldsWithoutExpose) {
	...
	public static <T> T fromJson(final String json, final TypeToken<T> token,
			String datePattern) {
	...
	public static <T> T fromJson(final String json, final Type typeOfT) {
		...
		try {
			...
			LOGGER.error(json + " 无法转换为 " + json + " 对象!", ex);
			return null;
		}
	}
